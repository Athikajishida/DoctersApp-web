...
const PastAppointments: React.FC<PastAppointmentsProps> = ({ 
  ...
  const [sortOrder, setSortOrder] = useState<SortOrder>('desc'); // Past appointments should default to newest first
  ...
  const { 
    ...
    itemsPerPage,
    setPage 
  } = useTabAppointments('past', searchTerm, sortField, sortOrder);
